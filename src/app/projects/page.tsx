      ...
      <div className="max-w-7xl mx-auto">
              ...
              <div className="order-1 lg:order-2 space-y-6">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <div className="flex -space-x-3">
                      {featuredProject.builders.slice(0, 4).map((builder, index) => (
                        <div key={index} className="w-12 h-12 rounded-full bg-gray-700 overflow-hidden border-3 border-gray-900">
                          <Image
                            src={builder.image}
                            alt={builder.name}
                            width={48}
                      ...
                      {featuredProject.builders.length > 4 && (
                        <div className="w-12 h-12 rounded-full bg-gray-700 border-3 border-gray-900 flex items-center justify-center">
                          <span className="text-sm font-medium text-white">+{featuredProject.builders.length - 4}</span>
                        </div>
                      )}
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Team of {featuredProject.builders.length} builder{featuredProject.builders.length > 1 ? 's' : ''}</p>
                    </div>
                  </div>
                ...
                <div className="flex flex-wrap gap-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-gray-800 hover:bg-gray-700 px-6 py-3 rounded-xl font-semibold transition-colors duration-200 flex items-center gap-3"
                  >
                  ...
                  {featuredProject.liveLink && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-[#7736F8] hover:bg-[#7736F8]/80 px-6 py-3 rounded-xl font-semibold transition-colors duration-200 flex items-center gap-3"
                    >
        ...
        <div className="text-center bg-gray-900/50 rounded-3xl p-12 border border-gray-800">
          ...
          <p className="text-gray-400 mb-8 text-lg max-w-2xl mx-auto">
            Join our community of student builders. We don't care about perfect — we care about passionate.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#7736F8] hover:bg-[#7736F8]/80 px-8 py-4 rounded-xl font-semibold transition-colors duration-200 flex items-center justify-center gap-3"
            >
              Join Waffle Community
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
              </svg>
            </Link>
            <Link
              ...
              className="bg-gray-800 hover:bg-gray-700 px-8 py-4 rounded-xl font-semibold transition-colors duration-200 flex items-center justify-center gap-3"
            >
              Submit Your Project
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
