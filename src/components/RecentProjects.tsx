          ...
          <div className="flex flex-col lg:flex-row gap-6 bg-gray-900/80 rounded-2xl p-6 border border-gray-800">
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="bg-gray-900/90 rounded-lg p-4">
                <p className="text-sm font-semibold text-white mb-3">Built by:</p>
                <div className="space-y-3">
                  {featuredProject.builders.map((builder, index) => (
                    <div key={index} className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-gray-700 overflow-hidden border-2 border-gray-900">
                          <Image
                            src={builder.image}
                            alt={builder.name}
                            width={40}
                        ...
                        <span className="font-semibold text-white text-sm">{builder.name}</span>
                      </div>
                    ...
                    {project.builders.map((builder, builderIndex) => (
                      <div key={builderIndex} className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className="w-5 h-5 rounded-full bg-gray-700 overflow-hidden border border-gray-600">
                            <Image
                              src={builder.image}
                              alt={builder.name}
                              width={20}
                          ...
                          <span className="text-xs font-medium text-gray-300">{builder.name}</span>
                        </div>
